...
public class ClientEventBusSubscriber {
	...
	public static void clientSetup(FMLClientSetupEvent event) {
		...
		RenderTypeLookup.setRenderLayer(BlockInit.STONE_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.ANDESITE_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.DIORITE_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.GRANITE_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.SANDSTONE_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.RED_SANDSTONE_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.BLACKSTONE_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.NETHER_BRICK_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.END_BRICK_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.QUARTZ_PILLAR_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.PRISMARINE_PILLAR_WALL.get(), RenderType.cutout());
		
		RenderTypeLookup.setRenderLayer(BlockInit.STONE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.ANDESITE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.DIORITE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.GRANITE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.SANDSTONE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.RED_SANDSTONE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.BLACKSTONE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.NETHER_BRICK_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.END_BRICK_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.QUARTZ_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.PRISMARINE_GRASS_TOPPED_WALL.get(), RenderType.cutout());
		
		RenderTypeLookup.setRenderLayer(BlockInit.WOODEN_CHEVAL_DE_FRISE.get(), RenderType.cutout());
		RenderTypeLookup.setRenderLayer(BlockInit.IRON_CHEVAL_DE_FRISE.get(), RenderType.cutout());
}
}
