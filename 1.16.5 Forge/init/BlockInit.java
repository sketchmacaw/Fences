...
public class BlockInit {
	...
	public static final RegistryObject<Block> OAK_WIRED_FENCE = BLOCKS.register("oak_wired_fence", () -> new WiredFence(Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> STONE_PILLAR_WALL = BLOCKS.register("stone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> ANDESITE_PILLAR_WALL = BLOCKS.register("andesite_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DIORITE_PILLAR_WALL = BLOCKS.register("diorite_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> GRANITE_PILLAR_WALL = BLOCKS.register("granite_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> SANDSTONE_PILLAR_WALL = BLOCKS.register("sandstone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> RED_SANDSTONE_PILLAR_WALL = BLOCKS.register("red_sandstone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> BLACKSTONE_PILLAR_WALL = BLOCKS.register("blackstone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> NETHER_BRICK_PILLAR_WALL = BLOCKS.register("nether_brick_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> END_BRICK_PILLAR_WALL = BLOCKS.register("end_brick_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> QUARTZ_PILLAR_WALL = BLOCKS.register("quartz_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> PRISMARINE_PILLAR_WALL = BLOCKS.register("prismarine_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

	public static final RegistryObject<Block> STONE_GRASS_TOPPED_WALL = BLOCKS.register("stone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> ANDESITE_GRASS_TOPPED_WALL = BLOCKS.register("andesite_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DIORITE_GRASS_TOPPED_WALL = BLOCKS.register("diorite_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> GRANITE_GRASS_TOPPED_WALL = BLOCKS.register("granite_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> SANDSTONE_GRASS_TOPPED_WALL = BLOCKS.register("sandstone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> RED_SANDSTONE_GRASS_TOPPED_WALL = BLOCKS.register("red_sandstone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> BLACKSTONE_GRASS_TOPPED_WALL = BLOCKS.register("blackstone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> NETHER_BRICK_GRASS_TOPPED_WALL = BLOCKS.register("nether_brick_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> END_BRICK_GRASS_TOPPED_WALL = BLOCKS.register("end_brick_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> QUARTZ_GRASS_TOPPED_WALL = BLOCKS.register("quartz_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> PRISMARINE_GRASS_TOPPED_WALL = BLOCKS.register("prismarine_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> IRON_CHEVAL_DE_FRISE = BLOCKS.register("iron_cheval_de_frise", () -> new StoneWiredFence(Block.Properties.of(Material.METAL, MaterialColor.METAL).strength(2.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
