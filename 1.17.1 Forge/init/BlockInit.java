...
public class BlockInit {
	...
	public static final RegistryObject<Block> AZALEA_HEDGE = BLOCKS.register("azalea_hedge", () -> new WallBlock(Block.Properties.of(Material.LEAVES, MaterialColor.COLOR_GREEN).strength(0.2F, 0.3F).sound(SoundType.GRASS)));
	public static final RegistryObject<Block> FLOWERING_AZALEA_HEDGE = BLOCKS.register("flowering_azalea_hedge", () -> new WallBlock(Block.Properties.of(Material.LEAVES, MaterialColor.COLOR_GREEN).strength(0.2F, 0.3F).sound(SoundType.GRASS)));
	...
	public static final RegistryObject<Block> MODERN_DEEPSLATE_WALL = BLOCKS_STONE.register("modern_deepslate_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> MODERN_DEEPSLATE_BRICK_WALL = BLOCKS_STONE.register("modern_deepslate_brick_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> RAILING_DEEPSLATE_WALL = BLOCKS_STONE.register("railing_deepslate_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> RAILING_DEEPSLATE_BRICK_WALL = BLOCKS_STONE.register("railing_deepslate_brick_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> DEEPSLATE_RAILING_GATE = BLOCKS_STONE.register("deepslate_railing_gate", () -> new FenceGateBlock(Block.Properties.of(Material.STONE, MaterialColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DEEPSLATE_BRICK_RAILING_GATE = BLOCKS_STONE.register("deepslate_brick_railing_gate", () -> new FenceGateBlock(Block.Properties.of(Material.STONE, MaterialColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> STONE_PILLAR_WALL = BLOCKS_STONE.register("stone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> ANDESITE_PILLAR_WALL = BLOCKS_STONE.register("andesite_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DIORITE_PILLAR_WALL = BLOCKS_STONE.register("diorite_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> GRANITE_PILLAR_WALL = BLOCKS_STONE.register("granite_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> SANDSTONE_PILLAR_WALL = BLOCKS_STONE.register("sandstone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> RED_SANDSTONE_PILLAR_WALL = BLOCKS_STONE.register("red_sandstone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> BLACKSTONE_PILLAR_WALL = BLOCKS_STONE.register("blackstone_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> NETHER_BRICK_PILLAR_WALL = BLOCKS_STONE.register("nether_brick_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> END_BRICK_PILLAR_WALL = BLOCKS_STONE.register("end_brick_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DEEPSLATE_PILLAR_WALL = BLOCKS_STONE.register("deepslate_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DEEPSLATE_BRICK_PILLAR_WALL = BLOCKS_STONE.register("deepslate_brick_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> QUARTZ_PILLAR_WALL = BLOCKS_STONE.register("quartz_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> PRISMARINE_PILLAR_WALL = BLOCKS_STONE.register("prismarine_pillar_wall", () -> new FenceBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

	public static final RegistryObject<Block> STONE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("stone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> ANDESITE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("andesite_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DIORITE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("diorite_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> GRANITE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("granite_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> SANDSTONE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("sandstone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> RED_SANDSTONE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("red_sandstone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> BLACKSTONE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("blackstone_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> NETHER_BRICK_GRASS_TOPPED_WALL = BLOCKS_STONE.register("nether_brick_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> END_BRICK_GRASS_TOPPED_WALL = BLOCKS_STONE.register("end_brick_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DEEPSLATE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("deepslate_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DEEPSLATE_BRICK_GRASS_TOPPED_WALL = BLOCKS_STONE.register("deepslate_brick_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> QUARTZ_GRASS_TOPPED_WALL = BLOCKS_STONE.register("quartz_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> PRISMARINE_GRASS_TOPPED_WALL = BLOCKS_STONE.register("prismarine_grass_topped_wall", () -> new WallBlock(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

	public static final RegistryObject<Block> WOODEN_CHEVAL_DE_FRISE = BLOCKS.register("wooden_cheval_de_frise", () -> new WiredFence(Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(1.0F, 3.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> IRON_CHEVAL_DE_FRISE = BLOCKS_STONE.register("iron_cheval_de_frise", () -> new StoneWiredFence(Block.Properties.of(Material.METAL, MaterialColor.METAL).strength(2.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
