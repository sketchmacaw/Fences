...
public class BlockInit {
    ...
    public static final Block MANGROVE_PICKET_FENCE = registerBlock("mangrove_picket_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8f, 3.0f).nonOpaque()), FencesGroup.FENCESGROUP);
    ...
    public static final Block MANGROVE_STOCKADE_FENCE = registerBlock("mangrove_stockade_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8f, 3.0f).nonOpaque()), FencesGroup.FENCESGROUP);
    ...
    public static final Block MANGROVE_HORSE_FENCE = registerBlock("mangrove_horse_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8f, 3.0f).nonOpaque()), FencesGroup.FENCESGROUP);
    ...
    public static final Block MANGROVE_HIGHLEY_GATE = registerBlock("mangrove_highley_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8f, 3.0f).nonOpaque()), FencesGroup.FENCESGROUP);
    ...
    public static final Block MANGROVE_PYRAMID_GATE = registerBlock("mangrove_pyramid_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8f, 3.0f).nonOpaque()), FencesGroup.FENCESGROUP);
    ...
    public static final Block MODERN_MUD_BRICK_WALL = registerBlock("modern_mud_brick_wall", new FenceBlock(FabricBlockSettings.of(Material.STONE, MapColor.DIRT_BROWN).requiresTool().sounds(BlockSoundGroup.STONE).strength(3.0f, 6.0f).nonOpaque()), FencesGroup.FENCESGROUP);
    ...
    public static final Block RAILING_MUD_BRICK_WALL = registerBlock("railing_mud_brick_wall", new FenceBlock(FabricBlockSettings.of(Material.STONE, MapColor.DIRT_BROWN).requiresTool().sounds(BlockSoundGroup.STONE).strength(3.0f, 6.0f).nonOpaque()), FencesGroup.FENCESGROUP);
    ...
    public static final Block MUD_BRICK_RAILING_GATE = registerBlock("mud_brick_railing_gate", new FenceGateBlock(FabricBlockSettings.of(Material.STONE, MapColor.DIRT_BROWN).sounds(BlockSoundGroup.STONE).strength(3.0f, 6.0f).nonOpaque()), FencesGroup.FENCESGROUP);
